...
{
  int initValue = 0;
  const raii::unique_rc<int*, raii::pointer_deleter_wrapper<do_nothing>> uptr1{ &initValue };
...
{
  int initValue = 0;
  const raii::unique_ptr<int, raii::pointer_deleter_wrapper<do_nothing>> uptr1{ &initValue };
